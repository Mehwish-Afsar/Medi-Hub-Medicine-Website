...
const PRODUCTS = [
  ...
  { id:'lacr',  name:'Lactogen Recover 200g',             cat:'baby',   price:713,  img:"images/Lactogen Recover 200 Grams.png" },
  { id:'bunyad',name:'Nestle Bunyad 260g',                cat:'baby',   price:2550, img:"images/Nestle Bunyad 260 grams.jpeg" },
  { id:'cerelac',name:'Nestle Cerelac 175g',              cat:'baby',   price:340,  img:"images/Nestle Cerelac 175 grams.jpeg" },
  { id:'cerelacw',name:'Nestle Cerelac Wheat 175g',       cat:'baby',   price:350,  img:"images/Nestle Cerelac Wheat 175 grams.png" },
  { id:'feeder',name:'Cuddles Wide Neck Feeder 60ml',     cat:'baby',   price:606,  img:"images/Baby Feeder.png" },
  { id:'tcup',  name:'Shield Training Cup',                cat:'baby',   price:200,  img:"images/Training Cup.jpeg" },
  { id:'soother',name:'Silicone Soother & Teether',       cat:'baby',   price:298,  img:"images/Soother And Teether.jpeg" },

  // Medicines
  { id:'disprin',name:'Disprin',                          cat:'medicine', price:21,  img:"images/Disprin.jpeg" },
  { id:'panadol',name:'Panadol',                          cat:'medicine', price:25,  img:"images/panadol.jpg" },
  { id:'feldene',name:'Feldene',                          cat:'medicine', price:694, img:"images/Feldene.jpeg" },
  { id:'brufen',name:'Brufen 100mg/5ml Suspension 120ml', cat:'medicine', price:85,  img:"images/Brufen.jpeg" },
  { id:'febrol',name:'Febrol 60ml Suspension',            cat:'medicine', price:49,  img:"images/Febrol.jpeg" },
  { id:'calpol',name:'Calpol 500mg Tablets',               cat:'medicine', price:25,  img:"images/Calpol.jpeg" },
  { id:'amoxil',name:'Amoxil 250mg Tablets',               cat:'medicine', price:225, img:"images/amoxil-250mg.png", rx:true },
  { id:'flagyl',name:'Flagyl',                             cat:'medicine', price:30,  img:"images/flaygl.jpg" },
  { id:'lmeth', name:'L-Methionine',                       cat:'medicine', price:330, img:"images/i.metionine.jpg" },
  { id:'cefix', name:'Cefixime Tablets 200mg',             cat:'medicine', price:200, img:"images/Cefixime.jpg", rx:true },
  { id:'augmentin',name:'Augmentin 375mg Tablets',        cat:'medicine', price:370, img:"images/augmenten.png", rx:true },
  { id:'wellme',name:'Wellme',                             cat:'medicine', price:420, img:"images/wellme10.png" },
  { id:'enta',  name:'Entamizol 250mg Tablets',            cat:'medicine', price:470, img:"images/entamizole.jpg", rx:true },
  { id:'rigix', name:'Rigix Tablets 10mg',                 cat:'medicine', price:470, img:"images/rigix.jpg" },
  { id:'strep', name:'Strepsils',                          cat:'medicine', price:420, img:"images/strepsil.jpg" },

  // Nutrition & supplements
  { id:'ensure',name:'Ensure Plus 250ml',                  cat:'nutrition', price:495,  img:"images/Ensure Plus.jpeg" },
  { id:'seamega',name:'Seamega Softgel Capsules',          cat:'nutrition', price:1045, img:"images/seamega capsules.jpg" },
  { id:'kidzvitz',name:'Kidzvitz Gummies',                 cat:'nutrition', price:1150, img:"images/kidzvitz gummies.jpg" },
  { id:'jointin',name:'NF Jointin-D Tablets',              cat:'nutrition', price:1990, img:"images/Nf Jointin D Tablets.png" },
  { id:'lipozin',name:'NF Lipozin Tablets',                cat:'nutrition', price:1490, img:"images/Nf Lipozin Tablets.jpeg" },
  { id:'folic', name:'Folic Acid 5mg Tablet',              cat:'nutrition', price:90,   img:"images/folic acid 5mg tablet.jpg" },
  { id:'pediasure',name:'Pediasure Chocolate 850g',        cat:'nutrition', price:3509, img:"images/Pediasure.jpg" },
  { id:'surbex',name:'Surbex 60 Tablets',                  cat:'nutrition', price:294,  img:"images/suebex.jpg" },
  { id:'cac',   name:'CaC-1000 Plus Tablet Orange',        cat:'nutrition', price:411,  img:"images/cac.jpg" },
  { id:'zinc',  name:"Nature's Bounty Zinc 50mg Tablets",  cat:'nutrition', price:3880, img:"images/Natures Bounty.jpeg" },
  { id:'hairaid',name:'Hair Aid Softgel Capsules',         cat:'nutrition', price:1050, img:"images/hairaid soft gel.jpg" },
  { id:'kidsgrow',name:'Bio Life NutriOne Kids Grow 400g', cat:'nutrition', price:1100, img:"images/Bio-Life-Nutri-One-Kids-Grow.png" },
  { id:'gainwt',name:'Vitamin To Gain Weight',              cat:'nutrition', price:1100, img:"images/Gain weight.jpg" },
